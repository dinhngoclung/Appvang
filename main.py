...
# ===================================================================
# GIAO DIỆN ĐỒ HỌA ỨNG DỤNG (ĐÃ SỬA ICON LỖI)
# ===================================================================
def main(page: ft.Page):
    ...
    # Dropdown chọn nhanh thư mục mẫu
    ...
    # Ô nhập text cho phép tự sửa/dán đường dẫn
    ...
    def quet_tim_file_excel(e=None):
        ...
        if not os.path.exists(target_dir):
            write_log("❌ Đường dẫn không tồn tại hoặc App chưa được cấp quyền bộ nhớ!")
    ...
    # THAY ICON REFRESH BẰNG AUTORENEW ĐỂ TRÁNH LỖI PHIÊN BẢN FLET
